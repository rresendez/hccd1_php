<html>
	...
	// Pull Down for Dept
  echo "<div>";
	echo "<form action=HCDD1_TSE.php method=post class='form-group'>";

	echo "<input type='text' name='search_box' value='' class='form-control' />";
	echo "<input type='submit' class='btn btn-default'name='search' value='Search'>";
	echo "<input type='submit' class='btn btn-default' name=Reset value=Reset>&nbsp;&nbsp;" ;
  echo "</div>";
  ...
  echo"<div>";
	echo "<select name='selectus1' width='150' style='width: 150px' class='form-control' >";
  ...
  echo"</div>";
	...
	echo "<input type='month' name='dateE' value='' class='form-control'/>&nbsp;&nbsp;&nbsp;&nbsp;";
	echo "<input type='submit' class='btn btn-default'name='filterdate' value='Date Filter'>";
	echo "<input type='submit' class='btn btn-default'name='QReport' value='Q Report'>";
	...
	//Table Columns
	echo "<table border='1'  class='table-hover'  id='table1'>
  <thead>
	...
	<th>User LN</th>
	<th>Proj ID</th>
	<th style='width:100px;'>Proj No</th>
	<th style='width:100px;'>Owner</th>
	<th style='width:100px;'>Pct</th>
	<th>Proj Name</th>
	<th>PDesc</th>
	<th>Date</th>
	<th>Time In</th>
	...
	echo "<td>" . "<input type='submit' class='btn btn-info' name='update' value='Update'" . "> </td>";
	echo "<td>" . "<input type='submit' class='btn btn-danger' name='delete' value='Del'." . "> </td>";
	echo "</tr>";
	echo "</form>";
	}
